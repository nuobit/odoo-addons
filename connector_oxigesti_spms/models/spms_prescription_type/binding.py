...
class SPMSPrescriptionTypeBinding(models.Model):
    ...
    @api.model
    def import_spms_prescription_type_since(self, backend_record, since_date=None):
        domain = []
        # if since_date:
    ...
    @api.model
    def export_spms_prescription_type_since(self, backend_record, since_date=None):
