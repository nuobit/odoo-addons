...
class AccountAssetAsset(models.Model):
    ...
    temp_deductible_prorrate_amount = fields.Float(string='Temporary deductible prorrate amount', readonly=True)
    temp_nondeductible_prorrate_amount = fields.Float(string='Temporary non-deductible prorrate amount', readonly=True)

    final_deductible_prorrate_amount = fields.Float(string='Final deductible prorrate amount', readonly=True)
    final_nondeductible_prorrate_amount = fields.Float(string='Final non-deductible prorrate amount', readonly=True)
    ...
    regularization_ids = fields.One2many(comodel_name='aeat.vat.special.prorrate.investment.good.regularization',
