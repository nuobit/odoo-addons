...
class BinderComposite(AbstractComponent):
    ...
    _default_binding_field = 'sapb1_bind_ids'
    ...
    def wrap_binding(self, relation, binding_field=None, binding_extra_vals={}):
        ...
        if wrap and hasattr(relation, binding_field):
            ...
            if not binding:
                ...
                # Example: I created a lighting.product and its binding
                # sapb1.lighting.product, it is exported, but we need to
            ...
            # If sapb1_bind_ids does not exist we are typically in a
