        ...
        if (cloned_action.report_type === 'json') {
                ...
                (_.isObject(cloned_action.data) && _.isEmpty(cloned_action.data)))
            {
                if(cloned_action.context.active_ids) {
                    report_json_url += '/' + cloned_action.context.active_ids.join(',');
                }
            } else {
                report_json_url += '?options=' + encodeURIComponent(JSON.stringify(cloned_action.data));
                report_json_url += '&context=' + encodeURIComponent(JSON.stringify(cloned_action.context));
            }
