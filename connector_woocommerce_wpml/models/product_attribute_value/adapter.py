...
class WooCommerceWPMLProductAttributeValueAdapter(Component):
    _name = "woocommerce.wpml.product.attribute.value.adapter"
    _inherit = "connector.woocommerce.wpml.adapter"

    _apply_on = "woocommerce.wpml.product.attribute.value"
    #
    # _inherit = "woocommerce.product.attribute.value.adapter"
