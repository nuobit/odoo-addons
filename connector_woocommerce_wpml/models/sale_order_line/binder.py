...
class WooCommerceWPMLSaleOrderLineBinder(Component):
    _name = "woocommerce.wpml.sale.order.line.binder"
    ...
    internal_id = [
        "woocommerce_wpml_order_line_id",
        "woocommerce_wpml_sale_order_id",
    ]
