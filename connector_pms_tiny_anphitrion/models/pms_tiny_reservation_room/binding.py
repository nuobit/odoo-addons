...
class AnphitrionPMSTinyReservationRoomBinding(models.Model):
    ...
    def create(self, vals_list):
        for vals in vals_list:
            ...
            binding = self.env["anphitrion.pms.tiny.reservation"].browse(
                anphitrion_reservation_id
            )
            # #TODO: use unwrap_binding bia binder instead accessing to odoo_id directly
