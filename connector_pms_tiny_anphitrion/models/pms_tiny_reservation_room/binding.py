...
class AnphitrionPMSTinyReservationRoomBinding(models.Model):
    ...
    #     related='anphitrion_reservation_id.backend_id',
    #     string='Backend',
    #     readonly=True,
    #     store=True,
    #     required=True,
    ...
    anphitrion_linea = fields.Integer(string="Anphitrion Linea", required=True)

    _sql_constraints = [
        (
            "ext_uniq",
            "unique(backend_id, anphitrion_numreserva, anphitrion_line_number)",
