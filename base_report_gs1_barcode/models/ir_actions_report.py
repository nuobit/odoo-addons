...
class IrActionsReport(models.Model):
    ...
    def barcode(self, barcode_type, value, width=600, height=100, humanreadable=0):
        if barcode_type == 'gs1-128':
            ...
            encoder = c128.Code128Encoder(data, options=dict(show_label=False, height=int(height)))
            ...
            return super().barcode(barcode_type, value, width=width, height=height, humanreadable=humanreadable)
