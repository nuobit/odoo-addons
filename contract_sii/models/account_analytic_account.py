...
class AccountAnalyticAccount(models.Model):
    ...
    def _prepare_invoice(self):
        ...
        if self.sii_registration_key_additional1:
            values['sii_registration_key_additional1'] = self.sii_registration_key_additional1.id
        if self.sii_registration_key_additional2:
            values['sii_registration_key_additional2'] = self.sii_registration_key_additional2.id
        ...
        if self.contract_type == 'sale':
            ...
            if self.sii_property_cadastrial_code:
                values['sii_property_cadastrial_code'] = self.sii_property_cadastrial_code
