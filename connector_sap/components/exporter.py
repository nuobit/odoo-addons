...
class SapBatchExporter(AbstractComponent):
...
class SapDirectBatchExporter(AbstractComponent):
    """ Import the records directly, without delaying the jobs. """
    _name = "sap.direct.batch.exporter"
    _inherit = "sap.batch.exporter"
...
class SapDelayedBatchExporter(AbstractComponent):
    """ Delay import of the records """
    _name = "sap.delayed.batch.exporter"
    _inherit = "sap.batch.exporter"
