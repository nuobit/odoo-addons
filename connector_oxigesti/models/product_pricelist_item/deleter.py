...
class OxigestiDirectBatchExportDeleter(Component):
    _name = "oxigesti.product.pricelist.item.direct.batch.export.deleter"
    _inherit = "oxigesti.direct.batch.export.deleter"
