...
class ProductPricelistItemExportMapper(Component):
    ...
    def IdArticulo(self, record):
        ...
        external_id = binder.to_external(record.product_tmpl_id.product_variant_id, wrap=True)
        assert external_id, (
    ...
    def IdCliente(self, record):
        ...
        assert external_id, (
                ...
                "does not exist on Backend" % (record.odoo_partner_id, record.odoo_partner_id.ref))
