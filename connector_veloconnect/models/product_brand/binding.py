...
class ProductSupplierinfoBinding(models.Model):
    ...
    odoo_id = fields.Many2one(comodel_name='product.brand',
                              string='Brand',
                              required=True,
                              ondelete='cascade')

    veloconnect_manufacturer_name = fields.Char(string='Veloconnect ManufacturersItemIdentificationName', required=True)
