...
class ProductBrand(models.Model):
    ...
    name_slug = fields.Char(string="Slug", compute="_compute_name_slug", search="_search_name_slug")
    ...
    def _search_name_slug(self, operator, value):
        ...
        brands = self.env[self._name].search([]).filtered(lambda x: x.name_slug == value)
