...
class VeloconnectAdapter(AbstractComponent):
    _name = "veloconnect.adapter"
    _inherit = ["base.backend.adapter.crud", "base.veloconnect.connector"]
    _description = 'Veloconnect Binding (abstract)'
