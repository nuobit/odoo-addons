...
class Payslip(models.Model):
    ...
    process_id = fields.Many2one(
        "payroll.sage.payslip.process.type", string="Process", required=True
    )
...
class PayslipProcess(models.Model):
    _name = "payroll.sage.payslip.process.type"
    _description = "Payslip process type"
    _order = "name"

    name = fields.Char("Description")

    payslip_ids = fields.One2many(
        "payroll.sage.payslip", "process_id", string="Payslips"
    )
