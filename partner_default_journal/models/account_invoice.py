...
class AccountInvoice(models.Model):
    ...
    def _onchange_partner_id(self):
        ...
        if self.partner_id.sale_journal_id and self.type in ('out_invoice', 'out_refund'):
            self.journal_id = self.partner_id.sale_journal_id
        elif self.partner_id.purchase_journal_id and self.type in ('in_invoice', 'in_refund'):
