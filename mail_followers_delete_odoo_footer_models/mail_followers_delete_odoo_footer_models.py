...
class mail_notification(osv.Model):
    ...
    def get_signature_footer(self, cr, uid, user_id, res_model=None,
        ...
        if user.company_id.website:
            website_url = ('http://%s' % user.company_id.website) \
                if not user.company_id.website.lower().startswith(('http:',
                                                                   'https:')) \
        ...
        footer = tools.append_content_to_html(footer, signature_company,
                                              plaintext=False,
                                              container_tag='div')
